        ...
        call.enqueue(new Callback<List<CourseObj>>() {
            ...
            public void onResponse(Call<List<CourseObj>> call, Response<List<CourseObj>> response) {
                if(response.isSuccessful()){
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<>(StudentMainActivity.this,
                    ...
                    LviewCourses.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            Intent i = new Intent(StudentMainActivity.this, StudentCourseMainActivity.class);
                    ...
                    Toast.makeText(StudentMainActivity.this, "No courses found!", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call call, Throwable t) {
                Toast.makeText(StudentMainActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
